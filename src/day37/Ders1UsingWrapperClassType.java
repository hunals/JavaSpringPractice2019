...
public class Ders1UsingWrapperClassType {
	...
	public static void main(String[] args) {
		...
		// since it return an integer object
		// we can store them inside Integer ref variable
		// if we store it in int variable it will outo unboxed into int value
		...
		// it will outoboxed into Integer object and pass as argument
