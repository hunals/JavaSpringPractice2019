...
public class Ders31 {
	...
	public static void main(String[] args) {
		...
		//System.out.println( numlst.get(7)); // 7 adet obje olmadigi icin hata veriryor
		
		
		// insert items at certain location
		...
		// it should be within range or exception occu
		// numlst.add(10, 500)
		...
		// checking whether an item exists in the li
