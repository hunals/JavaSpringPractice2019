...
public class Ders5 {
	...
	public static void main(String[] args) {
		...
		//Array class is a class that have a lot of
		// static method to perform common array operation
		...
		// sorting arraylist using sort method of Collections class did not learn
		Collections.sort(lst) ;   // alfabetik siralama yapar
		...
		Collections.shuffle(lst);  // her calsitirildiginda listeleme sirasi degisiyor
		System.out.println(lst);
		
		
		
		// sort method from ArrayList execct an object called Comparator we 
