...
Given a method printDataTypes with one string parameter, that must determine which primitive data types are capable of properly storing that input. Please complete an implementation of this method.
