...
public class StudentUtility {
	 ...
	 // create a private static field called studentList as ArrayList of Strin 
	...
	public static void main(String[] args) {
		...
		//StudentUtility.displayAllStudent() ;  // ikisinde de  ayni ciktiyi aliriz
		displayAllStudent();
		System.out.println("-----------------");
		addOneStudent("deya");
		addOneStudent("kubra");
	...
	public static void  displayAllStudent() {
		...
		public static void loadAllMyData() {
			...
			studentList.add("Eren");
			studentList.add("Enver");
