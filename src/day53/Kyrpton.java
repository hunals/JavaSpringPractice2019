...
public class Kyrpton extends Planet {
...
//	 }
	...
	// not valid since we can not reduce access modifier visiblity
//	 public void rotate(){
//		System.out.println("Superman's planet rotating protected");
//}
	
	// not a overriding method
	// it is overloading the rotate methods of super class
//	 protected public void rotate(String x){
...
//	}
	...
	public static int rotate(int d, int y) {
		System.out.println("Superman is rotating d with return");
		return 105 ;
	}
