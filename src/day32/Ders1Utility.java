...
//		there are two ways to call static methods
		 ...
		 * */
//		we can use directly static.Method(params) to call static methods
		
//		we are printing out so we can see the result of method call
		System.out.println( giveMe5()  );
//		we can use className.staticMetod(params) to call static methods
		System.out.println( Ders1Utility.giveMe5());
