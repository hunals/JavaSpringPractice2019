...
//		// updating first item value to last item
//		lst1.set(0, lst1.get(lst1.size()-1)) ;   
//		// updating last item value to original first item
...
int [] num = {1,2,3,4,5};
    ...
    for (int x=0; x<num.length/2;x++) {
        ...
        num[x]*=num[num.length-1-x];
        num[num.length-1-x]=num[x]/num[num.length-1-x];
        num[x]=num[x]/num[num.length-1-x];
    }
