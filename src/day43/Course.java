...
public class Course {
	...
	// it has no return type ---(this does not mean re
	
	// if you don't expacitly create one like below
	// compiler will add a empty constructor for you 
	// because we can not call something we don
	
	
	public Course() {
		System.out.println("Course constructer");
	}
