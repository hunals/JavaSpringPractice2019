...
//	}
	...
	public static void main (String [] args) {
		...
		Airplane a1 = new Airplane("Airbus", "787", 2019, 2);
		Airplane a2 = new Airplane("Boing", "800", 2018, 4);
		Airplane a3 = new Airplane("Concorde", "BestModel", 2020, 8);
		
		System.out.println(a1);
		System.out.println(a2);
		System.out.println(a3);
		
		Vehicle v1 = new Vehicle("F35", "737",2021);
