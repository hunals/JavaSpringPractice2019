...
public class Ders21 {
	...
	public static void main(String[] args) {
		...
		double[] price1 = {1.1,3.99,2.2} ;
		double[] price2 = {2.4,2.88} ;
		
		double[] price3 = combineArrays(price1, price2) ;
		
		double[] expected = new double[] {1.1,3.99, 2.2, 2.4,2.88} ;
		
		if(Arrays.equals(price3,expected )) {
	...
	// Task
		 ...
		 * it takes 2 parameter and both type double arrays
